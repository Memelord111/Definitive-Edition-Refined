...
function onUpdate(elapsed)
    if boyfriendName == 'bambi-3d-playable' or boyfriendName == 'expunged-3d-playable' or boyfriendName == 'unfair-3d-playable' or boyfriendName == 'dave-angey-playable' then --or boyfriendName == '3d-bf-alg' or boyfriendName == 'recurser-3d' then 
...
function onCreatePost()
    ...
    if songName == 'ePolygonized' or songName == 'Interdimensional' or songName == 'eletric-cockadoodledoo' then
