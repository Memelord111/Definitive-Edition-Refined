function onCreate()
	...
	makeLuaSprite('DayBG','bambi/sky', -500,-200)
	addLuaSprite('DayBG',false)
	setLuaSpriteScrollFactor('DayBG', 0.7, 0.7)
	setProperty('DayBG.alpha', 1)
	setProperty('DayBG.scale.x', 1);
	...
	makeLuaSprite('farm','bambi/funfarmhouse', 69, 65)
	addLuaSprite('farm',false)
	setLuaSpriteScrollFactor('farm', 0.6, 0.6)
	setProperty('farm.scale.x', 0.9);
    setProperty('farm.scale.y', 0.9);
