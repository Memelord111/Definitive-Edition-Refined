...
function onEvent(name, value1, value2)
	if name == 'Blammed Lights' then
		if value1 == '0' then --turn off
			this = 2
			doTweenAlpha('leave', 'black', 0, 0.35, 'linear')
