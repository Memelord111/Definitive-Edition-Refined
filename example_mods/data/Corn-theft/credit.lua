function onCreate()
    ...
    scaleObject('creditsheading', 0.9, 0.5)
...
makeLuaText('songby', 'Remix by Mr.Cheezer', -1000, -1000, 203)	--credit
...
doTweenX('creditscreatorx','creditscreator' , 315 , 0.5, 'backInOut')
end
