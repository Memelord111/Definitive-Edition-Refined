function onCreate()
    ...
    scaleObject('creditsheading', 1.1, 0.7)
...
makeLuaText('songby', 'Song by UltimateComposer', -1000, -1000, 203)	--credit
...
doTweenX('creditscreatorx','creditscreator' , 370 , 0.5, 'backInOut')
end
