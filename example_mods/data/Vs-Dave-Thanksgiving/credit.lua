function onCreate()
    makeLuaSprite('creditsheading', 'songHeadings/bevelHeading', -1010, 203)	--ur heading sprite
...
makeLuaText('songby', 'Song By BlueRatter', -1000, -1000, 203)	--credit
setTextSize('songby', 28)
...
doTweenX('creditscreatorx','creditscreator' , 260 , 0.5, 'backInOut')
end
