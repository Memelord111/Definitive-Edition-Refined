function onCreate()
    makeLuaSprite('creditsheading', 'songHeadings/daveHeading', -1010, 210)	--ur heading sprite
    scaleObject('creditsheading', 0.8, 0.7)
    ...
    makeLuaSprite('creditscreator', 'dave/MoldyGH', -650, 195)	--ur credit icon sprite
    scaleObject('creditscreator', 0.5, 0.5)
    setObjectCamera('creditscreator', 'camHUD')
    addLuaSprite('creditscreator', true)
end

function onCreatePost()
makeLuaText('songby', 'Song by EmarKey', -1000, -1000, 203)	--credit
...
doTweenX('creditscreatorx','creditscreator' , 239 , 0.5, 'backInOut')
end
