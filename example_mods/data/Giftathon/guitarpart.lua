function onCreate()
    ...
    makeLuaSprite('guitartbg','bambi/ch_highway', 450, -580)
    ...
    makeLuaSprite('bambispot','bambi/bambi_spot', -10, 30)
    ...
    makeLuaSprite('bFspot','bambi/boyfriend_spot', 1500, 450)
...
function onUpdate(elapsed)
    ...
    if curStep == 2944 then
        ...
        setCharacterX('dad', 472)
        setCharacterY('dad', 155)
        setCharacterX('boyfriend', 888)
