...
local comboThngPos = {nill, nil}        -- You alreaady know
...
if songName == 'Cheating' or songName == 'Unfairness' or songName == 'Exploitation' or songName == 'Polygonized' or songName == 'Interdimensional' or songName == 'Exploitation-old' then
    ...
    defaultPosRateGame[1], defaultPosRateGame[2] = getProperty('gf.x') + 400, getProperty('gf.y') + 210
        ...
        if not isSustainNote then
            ...
            if ANIMATED then
                ...
                if onPlayerCombo == true and camSet == 'hud' then
                    if ratiNum ~= nil then
                        makeLuaSprite(hmm ..'ly' .. eh, ratingGrab[ratiNum], 400 + comboOffset[1], 430 - comboOffset[2])
                    end
            ...
            if showComboThng == true then
                ...
                if stationaryMode == false then
                    setProperty('combThing' .. eh .. '.acceleration.y', 350)
                    setProperty('combThing' .. eh .. '.velocity.x', math.random(0,10))
                    setProperty('combThing' .. eh .. '.velocity.y', -100)
                end
